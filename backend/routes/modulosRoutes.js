...
router.get('/Modulos/Modulo-2-Tipos-de-Datos-y-Variables/300-Declaracion,-Inicializacion-y-Uso-de-Variables.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-2-Tipos-de-Datos-y-Variables/300-Declaracion,-Inicializacion-y-Uso-de-Variables.html"));
});
...
router.get('/Modulos/Modulo-2-Tipos-de-Datos-y-Variables/500-5.-Limites-y-Rangos-de-los-Tipos-de-Datos-Desbordamiento.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-2-Tipos-de-Datos-y-Variables/500-5.-Limites-y-Rangos-de-los-Tipos-de-Datos-Desbordamiento.html"));
});
...
router.get('/Modulos/Modulo-2-Tipos-de-Datos-y-Variables/600-Declaracion-de-Variables-y-Buenas-Practicas.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-2-Tipos-de-Datos-y-Variables/600-Declaracion-de-Variables-y-Buenas-Practicas.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/100-1-El-Flujo-de-Ejecucion-Lineal-vs-el-Control-de-Flujo.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/100-1-El-Flujo-de-Ejecucion-Lineal-vs-el-Control-de-Flujo.html"));
});

router.get('/Modulos/Modulo-4-Estructuras-de-Control/101-preguntas.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/101-preguntas.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/300-3-Estructuras-Condicionales-Multiples-switch-y-Anidamiento.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/300-3-Estructuras-Condicionales-Multiples-switch-y-Anidamiento.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/301-progra.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/301-progra.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/400-4-Bucles-de-Repeticion-por-Contador-for.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/400-4-Bucles-de-Repeticion-por-Contador-for.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/401-progra.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/401-progra.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/500-5-Bucles-de-Repeticion-Condicionales-while-do-while.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/500-5-Bucles-de-Repeticion-Condicionales-while-do-while.html"));
});
...
router.get('/Modulos/Modulo-4-Estructuras-de-Control/800-Resumen.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-4-Estructuras-de-Control/800-Resumen.html"));
});
...
router.get('/Modulos/Modulo-5-Funciones-y-Modularidad/100-1-Concepto-de-Modularidad-y-Reutilizacion-de-Codigo.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-5-Funciones-y-Modularidad/100-1-Concepto-de-Modularidad-y-Reutilizacion-de-Codigo.html"));
});
...
router.get('/Modulos/Modulo-5-Funciones-y-Modularidad/200--2-Definicion,-Declaracion-y-Llamada-de-Funciones.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-5-Funciones-y-Modularidad/200--2-Definicion,-Declaracion-y-Llamada-de-Funciones.html"));
});
...
router.get('/Modulos/Modulo-5-Funciones-y-Modularidad/300--3-Comunicacion-de-Datos-Paso-de-Argumentos-y-Parametros.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-5-Funciones-y-Modularidad/300--3-Comunicacion-de-Datos-Paso-de-Argumentos-y-Parametros.html"));
});
...
router.get('/Modulos/Modulo-5-Funciones-y-Modularidad/500--5-Ambito-Scope-de-las-Variables-Locales-y-Globales.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-5-Funciones-y-Modularidad/500--5-Ambito-Scope-de-las-Variables-Locales-y-Globales.html"));
});
...
router.get('/Modulos/Modulo-5-Funciones-y-Modularidad/600-6-Creacion-de-Librerias-Simples-Archivos-h-y-c-Conceptual.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/Modulo-5-Funciones-y-Modularidad/600-6-Creacion-de-Librerias-Simples-Archivos-h-y-c-Conceptual.html"));
});
...
router.get('/Modulos/modulo-6-Arrays-y-Punteros/200-2-Acceso-a-Elementos-Mediante-Indexacion.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-6-Arrays-y-Punteros/200-2-Acceso-a-Elementos-Mediante-Indexacion.html"));
});
...
router.get('/Modulos/modulo-6-Arrays-y-Punteros/400--4-Concepto-de-Puntero-y-Direccion-de-Memoria-.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-6-Arrays-y-Punteros/400--4-Concepto-de-Puntero-y-Direccion-de-Memoria-.html"));
});
...
router.get('/Modulos/modulo-6-Arrays-y-Punteros/600-6-Relacion-Fundamental-entre-Punteros-y-Arrays.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-6-Arrays-y-Punteros/600-6-Relacion-Fundamental-entre-Punteros-y-Arrays.html"));
});
...
router.get('/Modulos/modulo-7-Structs-y-Unions/200-2.-Declaracion-y-Uso-de-Structs-Estructuras.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-7-Structs-y-Unions/200-2.-Declaracion-y-Uso-de-Structs-Estructuras.html"));
});
...
router.get('/Modulos/modulo-7-Structs-y-Unions/500-5.-Concepto-y-Uso-de-Unions-para-Optimizacion-de-Memoria.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-7-Structs-y-Unions/500-5.-Concepto-y-Uso-de-Unions-para-Optimizacion-de-Memoria.html"));
});
...
router.get('/Modulos/modulo-7-Structs-y-Unions/600-6.-Campos-de-Bits-y-Alineacion-de-Datos-Concepto-Avanzado.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-7-Structs-y-Unions/600-6.-Campos-de-Bits-y-Alineacion-de-Datos-Concepto-Avanzado.html"));
});
...
router.get('/Modulos/modulo-8-Manipulacion-de-Archivos/300--Modos-de-Operacion-r-w--a--Lectura,-Escritura-y-Anexar.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-8-Manipulacion-de-Archivos/300--Modos-de-Operacion-r-w--a--Lectura,-Escritura-y-Anexar.html"));
...
router.get('/Modulos/modulo-8-Manipulacion-de-Archivos/400-4-Manipulacion-de-Archivos-de-Texto.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-8-Manipulacion-de-Archivos/400-4-Manipulacion-de-Archivos-de-Texto.html"));
});
...
router.get('/Modulos/modulo-8-Manipulacion-de-Archivos/500-5.-Manipulacion-de-Archivos-Binarios.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-8-Manipulacion-de-Archivos/500-5.-Manipulacion-de-Archivos-Binarios.html"));
});
...
router.get('/Modulos/modulo-8-Manipulacion-de-Archivos/600-6-Deteccion-de-Errores-y-Comprobacion-del-Fin-de-Archivo.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-8-Manipulacion-de-Archivos/600-6-Deteccion-de-Errores-y-Comprobacion-del-Fin-de-Archivo.html"));
});
...
router.get('/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/100-1.-Diferencia-entre-Memoria-Estatica-y-Memoria-Dinamica-Heap.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/100-1.-Diferencia-entre-Memoria-Estatica-y-Memoria-Dinamica-Heap.html"));
});
...
router.get('/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/200-2.-Asignacion-de-Memoria-la-funcion-malloc-.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/200-2.-Asignacion-de-Memoria-la-funcion-malloc-.html"));
});
...
router.get('/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/300-3-Redimension-de-Memoria-la-funcion-realloc.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/300-3-Redimension-de-Memoria-la-funcion-realloc.html"));
});
...
router.get('/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/400-4.-Inicializacion-de-Memoria-la-funcion-calloc.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/400-4.-Inicializacion-de-Memoria-la-funcion-calloc.html"));
});
...
router.get('/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/500-5.-Liberacion-de-Memoria-la-funcion-free.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/500-5.-Liberacion-de-Memoria-la-funcion-free.html"));
});
...
router.get('/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/600-6.-Fugas-de-Memoria-Memory-Leaks-y-Buenas-Practicas.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-9-Asignacion-de-Memoria-Dinamica/600-6.-Fugas-de-Memoria-Memory-Leaks-y-Buenas-Practicas.html"));
});
...
router.get('/Modulos/modulo-10-Listas-Enlazadas/100-1.-El-Problema-de-los-Arrays-de-Tamanyo-Fijo-.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-10-Listas-Enlazadas/100-1.-El-Problema-de-los-Arrays-de-Tamanyo-Fijo-.html"));
});
...
router.get('/Modulos/modulo-10-Listas-Enlazadas/300-3.-Creacion-de-Listas-Enlazadas-Simples.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-10-Listas-Enlazadas/300-3.-Creacion-de-Listas-Enlazadas-Simples.html"));
});
...
router.get('/Modulos/modulo-10-Listas-Enlazadas/400-4.-Operaciones-Fundamentales-Insercion-Inicio,-Fin,-Medio.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-10-Listas-Enlazadas/400-4.-Operaciones-Fundamentales-Insercion-Inicio,-Fin,-Medio.html"));
});
...
router.get('/Modulos/modulo-10-Listas-Enlazadas/500-5.-Operaciones-Fundamentales-Eliminacion-y-Recorrido.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-10-Listas-Enlazadas/500-5.-Operaciones-Fundamentales-Eliminacion-y-Recorrido.html"));
});
...
router.get('/Modulos/modulo-10-Listas-Enlazadas/600-6.-Aplicacion-Implementacion-Basica-de-una-Pila-o-Cola.html',isAuthenticated ,(req, res) => {
    res.sendFile(path.join(__dirname, "../../proyecto/dist/protected_html/Modulos/modulo-10-Listas-Enlazadas/600-6.-Aplicacion-Implementacion-Basica-de-una-Pila-o-Cola.html"));
});
